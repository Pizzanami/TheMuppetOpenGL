...
class Shader {
	private:
		...
		GLuint loadShader(GLenum type, char* filename) {
			...
			if (!success) {
				...
				std::cout << "ERROR::LOADSHADERS::COULD_NOT_COMPILE: " << filename << "\n";
				std::cout << infoLog << "\n";
			}
		...
		void linkProgram(GLuint vertexShader, GLuint geometryShader, GLuint fragmentShader) {
			...
			// Revisar si se linkearon adecuadamente los shaders
	...
	public:
		...
		Shader(char* vertexFile, char* fragmentFile, char* geometryFile = NULL) : versionMajor(versionMajor), versionMinor(versionMinor) {
